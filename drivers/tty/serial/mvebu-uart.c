...
/* Register Map */
#define UART0_RBR		0x00
#define UART1_RBR		0x18

#define UART0_TSH		0x04
#define UART1_TSH		0x1C

#define UART0_CTRL1		0x08
#define UART1_CTRL1		0x04
...
#define UART0_CTRL2		UART0_CTRL1
#define UART1_CTRL2		0x20
#define  CTRL0_TX_RDY_INT	BIT(5)
#define  CTRL1_TX_RDY_INT	BIT(6)
#define  CTRL0_RX_RDY_INT	BIT(4)
#define  CTRL1_RX_RDY_INT	BIT(5)

#define UART_STAT		0x0C
#define  STAT_TX_FIFO_EMP	BIT(13)
#define  STAT_TX_FIFO_FUL	BIT(11)
#define  STAT_TX_EMP		BIT(6)
#define  STAT0_TX_RDY		BIT(5)
#define  STAT1_TX_RDY		BIT(15)
#define  STAT0_RX_RDY		BIT(4)
#define  STAT1_RX_RDY		BIT(14)
...
/*
 * Driver data, a structure for each UART, linked with respect of the copatible
 * string (UART or extended UART).
 */
...
static void mvebu_uart_start_tx(struct uart_port *port)
{
	...
	if (port->line && !uart_circ_empty(xmit)) {
...
static int mvebu_uart_startup(struct uart_port *port)
{
	...
	if (!mvuart->irq[UART_TX_IRQ]) {
		...
		ret = devm_request_irq(port->dev, mvuart->irq[0],
...
static void mvebu_uart_putc(struct uart_port *port, int c)
{
	...
	writel(c, port->membase + UART0_TSH);
...
static struct mvebu_uart_driver_data uart0_driver_data = {
	.regs.rbr = UART0_RBR,
	.regs.tsh = UART0_TSH,
	.regs.ctrl = UART0_CTRL1,
	.regs.intr = UART0_CTRL2,
	.flags.ctrl_tx_rdy_int = CTRL0_TX_RDY_INT,
	.flags.ctrl_rx_rdy_int = CTRL0_RX_RDY_INT,
	.flags.stat_tx_rdy = STAT0_TX_RDY,
	.flags.stat_rx_rdy = STAT0_RX_RDY,
};

static struct mvebu_uart_driver_data uart1_driver_data = {
	.regs.rbr = UART1_RBR,
	.regs.tsh = UART1_TSH,
	.regs.ctrl = UART1_CTRL1,
	.regs.intr = UART1_CTRL2,
	.flags.ctrl_tx_rdy_int = CTRL1_TX_RDY_INT,
	.flags.ctrl_rx_rdy_int = CTRL1_RX_RDY_INT,
	.flags.stat_tx_rdy = STAT1_TX_RDY,
	.flags.stat_rx_rdy = STAT1_RX_RDY,
};
...
static const struct of_device_id mvebu_uart_of_match[] = {
	{
		...
		.data = (void *)&uart0_driver_data,
	},
	{
		.compatible = "marvell,armada-3700-uart-ext",
		.data = (void *)&uart1_driver_data,
	},
	{}
};
